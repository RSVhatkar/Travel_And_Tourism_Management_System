...
public class DeleteDetails extends JFrame implements ActionListener{
	...
	DeleteDetails(String susername)
	{
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		{
			Conn c=new Conn();
			String query1="delete from account where username = '"+susername+"' ";
			String query2="delete from bookhotel where username = '"+susername+"' ";
			String query3="delete from bookpackage where username = '"+susername+"' ";
			String query4="delete from customer where username = '"+susername+"' ";
